...
namespace Lycoris.Snowflakes
{
    public static class DistributedSnowflakeHelper
    {
        ...
        /// 
        /// </summary>
        private static DistributedSnowflakeOption _option;
        ...
        /// </summary>
        /// <returns></returns>
        private static async Task InitWorkAsync() => _workId = _distributedSupport != null ? await _distributedSupport.GetNextWorkIdAsync() : _option.WorkId;
    }
}
